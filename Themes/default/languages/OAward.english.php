...
$txt['OAward_error_no_valid_path'] = 'The directory for the images does not exists. The mod uses the follow url to access the images<br />'. $settings['default_images_url'] . '/medals/<br /> Make sure this directory does exists inside the default/images/ directory.';
