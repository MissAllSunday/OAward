...
// Admin
$txt['OAward_admin_desc'] = 'This is the main O Award admin panel <br/> The images folder is located at '. $settings['default_images_url'] .'/medals/ folder.';
...
$txt['OAward_admin_folder_path'] = 'The path to the image\'s folder';
$txt['OAward_admin_folder_path_sub'] = 'This gotta be a valid folder path, if left empty the mod will use the default value:>br /> '. $settings['default_images_url'] . '/medals/'. $award['award_image'];
$txt['OAward_admin_'] = '';
$txt['OAward_admin_'] = '';
$txt['OAward_admin_'] = '';
$txt['OAward_admin_'] = '';
