...
$txt['OAward_error_no_valid_path'] = 'The folder for the images does not exists. <br />If this is your first time setting uo the mod then write a valid url for the images folder or leave it empty and save the settings, the mod will use the default folder: '. $settings['default_images_url'] . '/medals/';
